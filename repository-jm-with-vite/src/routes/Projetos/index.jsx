...
const Projetos = () => {
    ...
    return(
        <section className="default-pages">
            ...
            <ProjectSlide direction={"right"} image={ImgUrna} tittle={"Urna Eleitoral"} linkView={"https://urna-eletronica-ten.vercel.app/index.html"} text={textUrna} techsIcons={arrayIconsHTMLcssJS} />
            <ProjectSlide direction={"left"} image={ImgWindows7} tittle={"Clone do Windows 7"} linkView={"https://windows-7-interface.vercel.app/"} text={textWindows7} techsIcons={arrayIconsWindows7} />
            <ProjectSlide direction={"right"} image={ImgWindows10} tittle={"Clone do Windows 10"} linkView={"https://windows-7-interface.vercel.app/"} text={textWindows10} techsIcons={arrayIconsHTMLcssJS} />
            <ProjectSlide direction={"left"} image={ImgToDoList} tittle={"To do List React"} text={textToDoList} linkView={"https://primeiro-projeto-reactjs.vercel.app/"} techsIcons={arrayIconsToDoList} />
            <ProjectSlide direction={"right"} image={ImgToDoListWithBootstrap} tittle={"To do List em React Bootstrap com API"} linkView={"https://todolist-react-bootstrap.vercel.app/"} text={textToDoListWithBootstrap} techsIcons={arrayIconsFullReactProject} />
            <ProjectSlide direction={"left"} image={Img4andar} tittle={"Quarto Andar"} linkView={"https://4-andar.vercel.app/"} text={text4andar} techsIcons={arrayIconsFullReactProject} />
        </section>
    )
}
